...
static const char *fonts[]          = { "Terminus, Terminus Nerd Font:size=17:antialis=true:autohint=true" };
static const char dmenufont[]       = "Terminus, Terminus Nerd Font:size=17:antialias=true:autohint=true";
...
static const char *volup[]         = { "amixer",  "set", "Master", "9+", 	    NULL };
static const char *voldown[]       = { "amixer",  "set", "Master", "9-",	    NULL };
